...
(
  ...
  pandoc -s -t html5 --mathjax="$mathjax_url" --metadata=lang=en --lua-filter="$script_dir/pandoc/math105.lua" --include-in-header="$script_dir/pandoc/math105-header.html" --extract-media=media --resource-path=".:../figs:.." "$prepared_name"
